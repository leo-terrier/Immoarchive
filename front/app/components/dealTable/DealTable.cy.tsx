...
describe('<DealTable/>', () => {
    it(`Mounts with table lines when map is not clustered`, () => {
        cy.mount(
            <AppContext.Provider
                value={{
                    ...mockContext,
    ...
    it(`Mounts with placeholder 'no transaction' when length = 0`, () => {
        cy.mount(
            <AppContext.Provider
                value={{
                    ...mockContext,
    ...
    it(`Mounts with placeholder 'trop de transactions' when isClustered = true`, () => {
        cy.mount(
            <AppContext.Provider
                value={{
                    ...mockContext,
